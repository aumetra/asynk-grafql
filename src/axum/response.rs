...
pub struct GraphQLResponse(pub crate::BatchResponse);

impl From<crate::Response> for GraphQLResponse {
    fn from(resp: crate::Response) -> Self {
        Self(resp.into())
    }
}

impl From<crate::BatchResponse> for GraphQLResponse {
    fn from(resp: crate::BatchResponse) -> Self {
        Self(resp)
    }
}
