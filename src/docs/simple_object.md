...
| concretes     | Specify how the concrete type of the generic SimpleObject should be implemented. *[See also the Book](https://asynk-grafql.github.io/asynk-grafql/en/define_simple_object.html#generic-simpleobjects) | ConcreteType                               | Y        |
