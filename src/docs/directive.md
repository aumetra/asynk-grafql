...
*[See also the Book](https://asynk-grafql.github.io/asynk-grafql/en/custom_directive.html).*
...
| name_type   | If `true`, the directive name will be specified from [`asynk_grafql::TypeName`](https://docs.rs/asynk-grafql/latest/asynk_grafql/trait.TypeName.html) trait                      | bool   | Y        |
