...
*[See also the Book](https://asynk-grafql.github.io/asynk-grafql/en/define_enum.html).*
...
| name_type    | If `true`, the enum name will be specified from [`asynk_grafql::TypeName`](https://docs.rs/asynk-grafql/latest/asynk_grafql/trait.TypeName.html) trait                        | bool   | Y        |
