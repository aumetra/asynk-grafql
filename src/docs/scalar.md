...
| name_type        | If `true`, the scalar name will be specified from [`asynk_grafql::TypeName`](https://docs.rs/asynk-grafql/latest/asynk_grafql/trait.TypeName.html) trait            | bool   | Y        |
